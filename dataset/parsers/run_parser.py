...
from split_long_to_json import split_long_to_json
...
# )
files_with_long_sent = glob.glob('/home/mudro/Documents/Projects/en-ukr-translater/dataset/raw/long/*.json')
...
split_long_to_json(files_with_long_sent, path_to_save=f'{curated_path}/cleared', max_len=MAX_LEN)
